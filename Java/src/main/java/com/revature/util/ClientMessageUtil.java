...
public class ClientMessageUtil {
	...
	public static final ClientMessage STOCK_SAVED = new ClientMessage("STOCK SAVED");
	public static final ClientMessage STOCK_WAS_NOT_SAVED = new ClientMessage("STOCK WAS NOT SAVED");
	public static final ClientMessage PURCHASE_REMOVAL_SUCCESSFUL = new ClientMessage("PURCHASE WAS REMOVED SUCCESSFULLY");
	public static final ClientMessage PURCHASE_REMOVAL_UNSUCCESSFUL = new ClientMessage("PURCHASE WAS REMOVED UNSUCCESSFULLY");
